...
-- for custom pop menu
-- vim.api.nvim_set_hl
-- vim.api.nvim_set_hl(0,"CocCustomPopup", { guifg = "#ebdbb2", guibg = "#282828" })
-- vim.highlight.create("CocCustomPopup", { guifg = "#ebdbb2", guibg = "#282828" })

-- border
-- vim.api.nvim_set_hl(0, "CocCustomPopupBoder", { guifg = "#5F5F5F", gui = "bold" })
-- vim.highlight.create("CocCustomPopupBoder", { guifg = "#5F5F5F", gui = "bold" })

-- selected row
-- vim.api.nvim_set_hl(0, "CocMenuSel", { guibg = "#3c3836", gui = "bold" })
-- vim.highlight.create("CocMenuSel", { guibg = "#3c3836", gui = "bold" })

-- matched_text
-- vim.api.nvim_set_hl(0, "CocSearch", { guifg = "#fabd2f" })
